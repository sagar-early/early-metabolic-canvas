...
import { Star, Search, User, Droplets, FileText, Lock } from 'lucide-react';
          ...
          <div className="hidden lg:flex lg:flex-col space-y-8 animate-fade-in order-1 lg:order-2">
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg">
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <span className="bg-accent text-accent-foreground px-3 py-1 rounded-full text-sm font-satoshi font-bold">
                  Save 70%
                </span>
              </div>
              ...
              <Button className="w-full bg-primary hover:bg-primary-light text-primary-foreground font-satoshi font-bold py-4 text-lg rounded-xl transition-all transform hover:scale-[1.02] shadow-lg">
                Buy Your Diagnosis Test Now
              </Button>
